...
func (b *blobUpload) Wait(ctx context.Context, fn func(ProgressResponse)) error {
	b.acquire()
	defer b.release()
...
func uploadBlob(ctx context.Context, mp ModelPath, layer *Layer, opts *RegistryOptions, fn func(ProgressResponse)) error {
